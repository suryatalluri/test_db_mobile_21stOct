...
import com.test_db_mobile_21stoct.testdatabase.service.Table2Service;
...
import com.test_db_mobile_21stoct.testdatabase.*;
import com.test_db_mobile_21stoct.testdatabase.service.*;


/**
 * Controller object for domain model class Table2.
 * @see com.test_db_mobile_21stoct.testdatabase.Table2
 */

@RestController(value = "TestDatabase.Table2Controller")
@Api(value = "/TestDatabase/Table2", description = "Exposes APIs to work with Table2 resource.")
@RequestMapping("/TestDatabase/Table2")
public class Table2Controller {

    private static final Logger LOGGER = LoggerFactory.getLogger(Table2Controller.class);

	@Autowired
	@Qualifier("TestDatabase.Table2Service")
