 ...
 */
@Service("TestDatabase.Table2Service")
public class Table2ServiceImpl implements Table2Service {
    ...
    @Autowired
    @Qualifier("TestDatabase.Table2Dao")
    ...
    public void setWMGenericDao(WMGenericDao<Table2, Integer> wmGenericDao){
     ...
     @Transactional(readOnly = true, value = "TestDatabaseTransactionManager")
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "TestDatabaseTransactionManager")
    @Override
